...
If you feel adventurous, you can instead give a try to the pre-release version. Since th source files of ``herakoi`` are hosted on `GitHub <https://github.com/lucadimascolo/herakoi>`_, you can directly clone the repository and install it from there:
